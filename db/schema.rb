...
ActiveRecord::Schema.define(version: 20190918091036) do
  ...
  create_table "santch_logs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "no"
    t.string "log"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "snatch_logs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "no"
    t.string "resource"
    t.string "log"
    t.datetime "created_at", null: false
